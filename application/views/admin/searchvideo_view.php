...
function deleVideo(vid, q, p, l){
	$.messager.confirm('刪除確認','刪除之後無法復原，確定要刪除？',function(r){
		if (r){
			location.assign('/coaadmin/deleVideo/'+vid+'?from=search&q='+q+'&p='+p+'&l='+l);
		}
	});
};
...
?>/></td>
                ...
                <td><a href="javascript:deleVideo(<?php echo $video->vid; ?>, '<?php echo $keyword; ?>', <?php echo $page; ?>, <?php echo $limit; ?>);"><img src="/images/delete.png"/></a></td>
              </tr>
<?php
		$lineoe++;
	}
